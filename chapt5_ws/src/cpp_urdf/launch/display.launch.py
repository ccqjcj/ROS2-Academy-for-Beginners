...
def generate_launch_description():
    ...
    cpp_urdf_dir = get_package_share_directory("cpp_urdf")
    default_model_path = os.path.join(cpp_urdf_dir,"urdf/urdf","demo01_helloworld.urdf")
    default_rviz_path = os.path.join(cpp_urdf_dir,"rviz","display.rviz")
